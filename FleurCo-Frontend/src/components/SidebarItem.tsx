...
export const SidebarItem: Component<SidebarItemProps> = (props) => {
    ...
    const classes = () => {
        const base = "p-2 rounded-md font-semibold transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-base-100 focus:ring-base-content/20";
        if (active()) {
